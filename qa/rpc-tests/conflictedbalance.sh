...
if [ $# -lt 1 ]; then
        ...
        echo "e.g. $0 ../../src"
        echo "Env vars NEWYORKCOIND and NEWYORKCOINCLI may be used to specify the exact binaries used"
        exit 1
fi

set -f

BITCOIND=${NEWYORKCOIND:-${1}/newyorkcd}
CLI=${NEWYORKCOINCLI:-${1}/newyorkcoin-cli}
