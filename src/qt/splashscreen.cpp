    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    int titleCopyrightVSpaceNYCoin = 40;
    ...
    QString titleText       = tr("NewYorkCoin Core");
    ...
    QString copyrightTextNYCoin  = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("The NewYorkCoin Core developers"));
    ...
    pixPaint.setFont(QFont(font, 10*fontFactor));
    pixPaint.drawText(pixmap.width()/devicePixelRatio-titleTextWidth-paddingRight,paddingTop+titleCopyrightVSpaceNYCoin,copyrightTextNYCoin);
