...
*Setup instructions for a gitian build of NewYorkCoin using a Debian VM or physical system.*
...
- [Building NewYorkCoin](#building-newyorkcoin)
...
Follow the instructions in [doc/release-process.md](release-process.md) in the newyorkcoin repository
under 'Fetch and build inputs' to install sources which require manual intervention. Also follow
the next step: 'Seed the Gitian sources cache', which will fetch all necessary source files allowing
for gitian to work offline.

Building NewYorkCoin
----------------

To build NewYorkCoin (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the newyorkcoin repository.
...
Output from `gbuild` will look something like
    ...
    From https://github.com/NewYorkCoin-NYC/nycoin
...
[newyorkcoin/gitian.sigs](https://github.com/newyorkcoin/gitian.sigs/) repository, or if that's not possible create a pull request. 
