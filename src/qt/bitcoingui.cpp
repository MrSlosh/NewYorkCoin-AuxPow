    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NewYorkCoin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("&About NewYorkCoin"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the NewYorkCoin help message to get a list with possible NewYorkCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NewYorkCoin client") + " " + networkStyle->getTitleAddText();
