...
<context>
    ...
    <message>
        ...
        <translation>交易费(NYCoin/kb)比这更小的交易在转发时将被视为零费交易 (默认: %s) </translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "NewYorkCoin Alert" admin@foo.com
        ...
        <translation>要使用 newyorkcd 或者 newyorkcoin-qt 中的 -server 选项，您必须在配置文件中设置一个密码：
%s
建议您使用下列随机密码：
rpcuser=newyorkcoinrpc
rpcpassword=%s
...
例如 alertnotify=echo %%s | mail -s "NewYorkCoin Alert" admin@foo.com
    ...
    <message>
        ...
        <translation>为付款交易添加交易费 (NYCoin/kb) (默认: %s) </translation>
    </message>
    <message>
        <source>Information</source>
        <translation>信息</translation>
