...
In order to support loading of multiple wallets in newyorkcoin-qt, a few changes in the UI architecture will be needed.
...
Finally, two new headers and source files will have to be added to newyorkcoin-qt.pro.
...
----------------------
bitcoin.cpp is the entry point into newyorkcoin-qt, and as such, will require some minor modifications to provide hooks for
